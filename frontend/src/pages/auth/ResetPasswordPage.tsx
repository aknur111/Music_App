...
export default function ResetPasswordPage() {
  ...
  if (!token) {
    return (
      <div className="min-h-dvh bg-[#06060e] flex items-center justify-center p-4 text-center">
        <div className="glass rounded-2xl p-8 max-w-sm w-full">
          <p className="text-[#94a3b8] mb-4">Invalid or expired reset link.</p>
          <Link to="/forgot-password" className="text-violet-400 hover:text-violet-300 font-medium text-sm">
            Request a new one
          </Link>
        </div>
      </div>
    ...
    <div className="min-h-dvh bg-[#06060e] flex items-center justify-center p-4">
      ...
      >
        <div className="text-center mb-8">
          ...
          <p className="mt-2 text-sm text-[#94a3b8]">Set a new password</p>
        </div>
