...
type AddCollaboratorRequest struct {
	...
	CollaboratorId string                 `protobuf:"bytes,3,opt,name=collaborator_id,json=collaboratorId,proto3" json:"collaborator_id,omitempty"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
func (x *AddCollaboratorRequest) GetOwnerId() string {
	if x != nil {
		return x.OwnerId
	}
	return ""
...
const file_playlist_playlist_proto_rawDesc = "" +
	...
	"\x0fcollaborator_id\x18\x03 \x01(\tR\x0ecollaboratorId\"3\n" +
	...
	"\x0eDeletePlaylist\x12\x1f.playlist.DeletePlaylistRequest\x1a .playlist.DeletePlaylistResponse\x12V\n" +
	"\x0fAddCollaborator\x12 .playlist.AddCollaboratorRequest\x1a!.playlist.AddCollaboratorResponseB8Z6github.com/NoneNon9/Music-app-protos/playlist;playlistb\x06proto3"
...
var file_playlist_playlist_proto_msgTypes = make([]protoimpl.MessageInfo, 15)
var file_playlist_playlist_proto_goTypes = []any{
	...
	(*AddCollaboratorRequest)(nil),    // 13: playlist.AddCollaboratorRequest
	(*AddCollaboratorResponse)(nil),   // 14: playlist.AddCollaboratorResponse
}
var file_playlist_playlist_proto_depIdxs = []int32{
	...
	13, // 9: playlist.PlaylistService.AddCollaborator:input_type -> playlist.AddCollaboratorRequest
	1,  // 10: playlist.PlaylistService.CreatePlaylist:output_type -> playlist.Playlist
	1,  // 11: playlist.PlaylistService.GetPlaylist:output_type -> playlist.Playlist
	5,  // 12: playlist.PlaylistService.ListUserPlaylists:output_type -> playlist.ListUserPlaylistsResponse
	7,  // 13: playlist.PlaylistService.AddSongToPlaylist:output_type -> playlist.AddSongResponse
	9,  // 14: playlist.PlaylistService.RemoveSongFromPlaylist:output_type -> playlist.RemoveSongResponse
	1,  // 15: playlist.PlaylistService.UpdatePlaylist:output_type -> playlist.Playlist
	12, // 16: playlist.PlaylistService.DeletePlaylist:output_type -> playlist.DeletePlaylistResponse
	14, // 17: playlist.PlaylistService.AddCollaborator:output_type -> playlist.AddCollaboratorResponse
